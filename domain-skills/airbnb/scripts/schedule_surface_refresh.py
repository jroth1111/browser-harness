...
CAPABILITY_PROBE_PATH = Path("agent-workspace/domain-skills/airbnb/.private-data/capability-probes")
OUTPUT_PATH = Path("agent-workspace/domain-skills/airbnb/.private-data/schedules")
